...
//        System.out.println("header:" + currentNode.getHeader());
     ...
     * @throws InvalidDataFormatException InvalidDataFormatException In case of unexpected data format, checked exception due to instantiated MutlilabelInstances.
     */

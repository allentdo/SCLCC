...
public class UnconditionalChiSquareIdentifier implements LabelPairsDependenceIdentifier,  Serializable {
    ...
    /**
     * Calculates Chi Square values for each pair of labels.  It uses Phi correlation value calculated in {@link Statistics} as follows: ChiSquareValue = PhiValue^2 * NumberOfInstances in the data set.
